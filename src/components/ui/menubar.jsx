...
const Menubar = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-10 items-center space-x-1 rounded-lg border border-border bg-card p-1",
      className
    )}
    {...props}
  />
  ...
  ({ className, align = "start", alignOffset = -4, sideOffset = 8, ...props }, ref) => (
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[12rem] overflow-hidden rounded-xl border border-border bg-card p-1 text-foreground shadow-xl animate-in slide-in-from-top-1",
          className
        )}
        {...props}
      />
...
export {
  ...
  MenubarPortal, MenubarSub, MenubarRadioGroup,
}
```
